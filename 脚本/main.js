...
//   apiKey: "AIzaSyCl_OYqD8cKkjpduqZ1EQ6uO0UC4nPws6g",
//   authDomain: "easy-chat-28a87.firebaseapp.com",
//   projectId: "easy-chat-28a87"
// });
//  var firesrore = firebase.firestore();
      ...
      this.firestore.collection('messages')
       ...
       .then((querySnapshot) => {
        querySnapshot.forEach((doc) => {
              this.displayMessage(doc.id, doc.date().name, doc.date().message, '/images/profile_placeholder.png')
          });
       })
    };
...
this.displayMessage(Date.now(), 'Otoha (name)', this.messageInput.value, '/images/profile_placeholder.png');

//   if (this.messageInput.value && this.checkSignedInWithMessage()){
//      this.firestore.collection('messages').add({
//         name: this.auth.currentUser.displayName,
//           message: this.messageInput.value,
//          photoURL: this.authu.currentUser.photoURL || '/imagesprofile_placeholder.png',
//          timestamp:new Date()
//     })
